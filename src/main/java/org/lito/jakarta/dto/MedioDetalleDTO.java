...
public class MedioDetalleDTO {
    ...
    private EspecificacionesMisilDTO especificacionesMisil;
    ...
    public EspecificacionesAereoDTO getEspecificacionesAereo() {
        return especificacionesAereo;
    }

    public void setEspecificacionesAereo(EspecificacionesAereoDTO especificacionesAereo) {
        this.especificacionesAereo = especificacionesAereo;
    }

    public EspecificacionesEwDTO getEspecificacionesEw() {
        return especificacionesEw;
    }

    public void setEspecificacionesEw(EspecificacionesEwDTO especificacionesEw) {
        this.especificacionesEw = especificacionesEw;
    }

    public EspecificacionesRadarDTO getEspecificacionesRadar() {
        return especificacionesRadar;
    }

    public void setEspecificacionesRadar(EspecificacionesRadarDTO especificacionesRadar) {
        this.especificacionesRadar = especificacionesRadar;
    }

    public EspecificacionesMisilDTO getEspecificacionesMisil() {
        return especificacionesMisil;
    }

    public void setEspecificacionesMisil(EspecificacionesMisilDTO especificacionesMisil) {
    ...
    public static class EspecificacionesEwDTO {
        ...
        public Boolean getCapacidadDrfm() {
    ...
    public static class EspecificacionesMisilDTO {
