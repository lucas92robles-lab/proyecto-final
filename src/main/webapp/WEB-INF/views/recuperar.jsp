...
<body class="pantalla-inicio">
    <div class="caja-login caja-recuperacion">
        ...
        <a href="${pageContext.request.contextPath}/app/auth/login" class="btn-ingresar">Volver al login</a>
    </div>
</body>
</html>